...
mdl.Material('Material-1').Elastic(table=((1.0, 0.3,),)) #USER INPUT

mdl.HomogeneousSolidSection('Section-1', 'Material-1')

part.uniformHexMesh(10, 30, 10, 1)  # MBB beam            #USER INPUT

part.SectionAssignment(part.Set('Set-1', part.elements), 'Section-1')

# Step and outputs
step = mdl.StaticStep('Step-1')
mdl.FieldOutputRequest('FieldOut-1', 'Step-1', variables=('MISESMAX', 'ESEDEN', 'EVOL', ))    #INPUT TYPES
mdl.HistoryOutputRequest('FieldOut-1', 'Step-1', variables=('ALLWK',))

# Load and boundary conditions                                                   #USER INPUTS
